    ...
    <>
      <div className="space-y-6">
        {currentResults.map((result, index) => {
          ...
          // Find index in the *complete* filtered list for a stable image
          const globalIndex = filteredResults.findIndex(r => r.id === searchResult.id);
          const imageIndex = globalIndex >= 0 ? globalIndex % imageUrls.length : index % imageUrls.length;
